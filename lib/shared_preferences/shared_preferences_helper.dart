...
// save value "first_time" to show intro of the app or not 
  ...
  // location
  static Future<bool> setUserlat(String lat) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<String> getUserlat() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString("lat") ?? '0';
  }

  static Future<bool> setUserlong(String long) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString("long", long);
  }

  static Future<String> getUserlong() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString("long") ?? '0';
  }
